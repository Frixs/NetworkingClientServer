...
/// Initialize colors.
void colors_init() {
    g_color_list[0] = memory_malloc(sizeof(char) * 7, 0);
    strcpy(g_color_list[0], "0000FF");

    g_color_list[1] = memory_malloc(sizeof(char) * 7, 0);
    strcpy(g_color_list[1], "FF0000");

    g_color_list[2] = memory_malloc(sizeof(char) * 7, 0);
